...
app.post('/', async (req, res) => {
    ...
    const response = await openai.createCompletion({
        ...
        prompt:  
        `Please be brief in your response. You have 250 tokens to use. Simply return quote on the inputted text, have a text break, then exhaustively go through all available. 
        ${message}`,
        max_tokens: 250,
        temperature: 0,
    });
