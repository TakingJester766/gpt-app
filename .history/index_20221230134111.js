...
app.post('/', async (req, res) => {
    ...
    const response = await openai.createCompletion({
        ...
        prompt:  
        `Going to be served a large amount of text. Do not give a response until a string is submitted in the format "User question: <question>". Until those keywords are met, do not respond in any way. 
        ${message}`,
        max_tokens: 500,
        temperature: 0,
    });
